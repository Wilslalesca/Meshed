...
import { ActivityFeedEnhanced } from "../components/ActivityFeed";
...
export const UserDashboard = () => {
    ...
    const activity = [
        {
            user: "Coach Miller",
            text: "Uploaded new weekly schedule",
            time: "Today",
        },
        {
            user: "System",
            text: "Facility ‘Pool’ closed for maintenance",
            time: "Yesterday",
        },
        {
            user: "Teammate",
            text: "Commented on session: ‘Nice work!’",
            time: "2 days ago",
        },
    ];
